...
export declare const getL1Network: (signerOrProvider: SignerOrProvider) => Promise<L1Network>;
export declare const getL2Network: (signerOrProvider: SignerOrProvider) => Promise<L2Network>;
