...
const networks_1 = require("@arbitrum/sdk-nitro/dist/lib/dataEntities/networks");
const networks_2 = require("../dataEntities/networks");
//\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
class MultiCaller {
    ...
    static async fromProvider(provider) {
        ...
        let multiCallAddr;
        if ((0, networks_2.isL1Network)(network)) {
