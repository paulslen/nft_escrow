...
class EventFetcher {
     ...
     * @returns
     */
    async getEvents(addr, contractFactory, topicGenerator, filter) {
        const contract = contractFactory.connect(addr, this.provider);
        const eventFilter = topicGenerator(contract);
        const fullFilter = Object.assign(Object.assign({}, eventFilter), { fromBlock: filter.fromBlock, toBlock: filter.toBlock });
