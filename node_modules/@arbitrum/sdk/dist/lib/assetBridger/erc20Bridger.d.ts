...
export declare class Erc20Bridger extends AssetBridger<TokenDepositParams, TokenWithdrawParams> {
    ...
    private readonly classicBridger;
    private readonly nitroBridger;
    /**
     * Bridger for moving ERC20 tokens back and forth betwen L1 to L2
     */
...
export declare class AdminErc20Bridger extends Erc20Bridger {
    private readonly adminClassicBridger;
    private readonly adminNitroBridger;
    /**
     * Bridger for moving ERC20 tokens back and forth betwen L1 to L2
     */
    constructor(l2Network: L2Network);
    ...
    getL1GatewaySetEvents(l1Provider: Provider, filter: {
        fromBlock: BlockTag;
        toBlock: BlockTag;
    }, customNetworkL1GatewayRouter?: string): Promise<GatewaySetEvent['args'][]>;
    /**
     ...
     * @returns
     */
    setGateways(l1Signer: Signer, l2Provider: Provider, tokenGateways: TokenAndGateway[], maxGas?: BigNumber): Promise<L1ContractCallTransaction>;
}
export {};
