...
export declare class L1ToL2MessageGasEstimator {
    ...
    private readonly classicEstimator;
    private readonly nitroEstimator;
     ...
     * @returns
     */
    estimateSubmissionFee(l1Provider: Provider, l1BaseFee: BigNumber, callDataSize: BigNumber | number, options?: {
        base?: BigNumber;
        percentIncrease?: BigNumber;
    }): Promise<BigNumber>;
    /**
     ...
     * @returns
     */
    estimateRetryableTicketGasLimit(sender: string, destAddr: string, l2CallValue: BigNumber, excessFeeRefundAddress: string, callValueRefundAddress: string, calldata: string, senderDeposit: BigNumber | undefined, maxSubmissionCost: BigNumber, maxGas: BigNumber, gasPriceBid: BigNumber): Promise<BigNumber>;
    /**
     ...
     * @returns
     */
    estimateAll(sender: string, l2CallTo: string, l2CallData: string, l2CallValue: BigNumber, l1BaseFee: BigNumber, excessFeeRefundAddress: string, callValueRefundAddress: string, l1Provider: Provider, options?: GasOverrides & {
