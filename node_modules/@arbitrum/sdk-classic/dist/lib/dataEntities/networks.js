...
exports.isL1Network = exports.getOutboxAddr = exports.addCustomNetwork = exports.getL2Network = exports.getL1Network = exports.l2Networks = exports.l1Networks = void 0;
...
const rinkebyETHBridge = {
    ...
    outboxes: {
        '0xefa1a42D3c4699822eE42677515A64b658be1bFc': ethers_1.BigNumber.from(0),
        '0x2360A33905dc1c72b12d975d975F42BaBdcef9F3': ethers_1.BigNumber.from(326),
    },
...
const mainnetETHBridge = {
    ...
    outboxes: {
        '0x667e23ABd27E623c11d4CC00ca3EC4d0bD63337a': ethers_1.BigNumber.from(0),
        '0x760723CD2e632826c38Fef8CD438A4CC7E7E1A40': ethers_1.BigNumber.from(30),
    },
...
const getNetwork = async (signerOrProviderOrChainID, layer) => {
    ...
    if (networks[chainID]) {
        ...
        throw new errors_1.ArbTsError(`Unrecognized network ${chainID}.`);
    }
};
...
const addCustomNetwork = ({ customL1Network, customL2Network, }) => {
    if (customL1Network) {
        if (exports.l1Networks[customL1Network.chainID]) {
            ...
            throw new Error(`Custom network ${customL1Network.chainID} must have isCustom flag set to true`);
        }
        else {
    ...
    if (exports.l2Networks[customL2Network.chainID])
        ...
        throw new Error(`Custom network ${customL2Network.chainID} must have isCustom flag set to true`);
    }
    ...
    if (!l1PartnerChain)
        throw new Error(`Network ${customL2Network.chainID}'s partner network, ${customL2Network.partnerChainID}, not recognized`);
...
const getOutboxAddr = (network, batchNumber) => {
    ...
    if (!res) {
        throw new errors_1.ArbTsError(`No outbox found for batch number: ${batchNumber.toString()} on network: ${network.chainID}.`);
    }
    return res[0];
};
