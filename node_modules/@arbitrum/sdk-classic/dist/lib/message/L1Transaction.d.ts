...
import { L1ToL2MessageReaderOrWriter, L1ToL2MessageWaitResult } from './L1ToL2Message';
...
export declare class L1TransactionReceipt implements TransactionReceipt {
     ...
     * @returns
     */
    getMessages(): MessageDeliveredEvent['args'][];
    /**
     ...
     * @param l2SignerOrProvider
     */
    getL1ToL2Message<T extends SignerOrProvider>(l2SignerOrProvider: T, messageNumberIndex?: number): Promise<L1ToL2MessageReaderOrWriter<T>>;
    /**
