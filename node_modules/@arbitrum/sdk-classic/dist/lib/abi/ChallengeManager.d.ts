...
export interface ChallengeManager extends BaseContract {
    ...
    functions: {
        ...
        currentResponderTimeLeft(challengeIndex: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        currentResponderTimeLeft(challengeIndex: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
