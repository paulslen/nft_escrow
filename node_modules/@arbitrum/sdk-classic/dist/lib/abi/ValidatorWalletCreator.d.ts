...
export interface ValidatorWalletCreatorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "createWallet", values?: undefined): string;
...
export interface ValidatorWalletCreator extends BaseContract {
    ...
    functions: {
        createWallet(overrides?: Overrides & {
    ...
    filters: {
        ...
        TemplateUpdated(): TemplateUpdatedEventFilter;
        "WalletCreated(address,address,address)"(walletAddress?: string | null, userAddress?: string | null, adminProxy?: null): WalletCreatedEventFilter;
        WalletCreated(walletAddress?: string | null, userAddress?: string | null, adminProxy?: null): WalletCreatedEventFilter;
    };
    estimateGas: {
        createWallet(overrides?: Overrides & {
            from?: string | Promise<string>;
