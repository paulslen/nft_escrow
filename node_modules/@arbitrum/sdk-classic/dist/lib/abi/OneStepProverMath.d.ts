...
export declare type ExecutionContextStructOutput = [BigNumber, string, string] & {
...
export declare type PcArrayStruct = {
    inner: BigNumberish[];
};
export declare type PcArrayStructOutput = [number[]] & {
    inner: number[];
};
export declare type PcStackStruct = {
    proved: PcArrayStruct;
    remainingHash: BytesLike;
};
export declare type PcStackStructOutput = [PcArrayStructOutput, string] & {
...
export declare type ModuleMemoryStructOutput = [BigNumber, string] & {
    size: BigNumber;
    merkleRoot: string;
};
