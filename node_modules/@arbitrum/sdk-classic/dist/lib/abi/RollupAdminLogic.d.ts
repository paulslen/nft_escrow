...
export interface RollupAdminLogicInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'setSequencerInboxMaxTimeVariation', values: [ISequencerInbox.MaxTimeVariationStruct]): string;
    ...
    decodeFunctionResult(functionFragment: 'setSequencerInboxMaxTimeVariation', data: BytesLike): Result;
...
export interface RollupAdminLogic extends BaseContract {
    ...
    functions: {
        ...
        setSequencerInboxMaxTimeVariation(maxTimeVariation: ISequencerInbox.MaxTimeVariationStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setSequencerInboxMaxTimeVariation(maxTimeVariation: ISequencerInbox.MaxTimeVariationStruct, overrides?: CallOverrides): Promise<void>;
