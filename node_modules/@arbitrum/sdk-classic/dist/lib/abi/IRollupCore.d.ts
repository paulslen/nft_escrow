...
export interface IRollupCore extends BaseContract {
    ...
    functions: {
        _stakerMap(stakerAddress: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber, string, boolean]>;
    ...
    estimateGas: {
        _stakerMap(stakerAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
        amountStaked(staker: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        _stakerMap(stakerAddress: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
