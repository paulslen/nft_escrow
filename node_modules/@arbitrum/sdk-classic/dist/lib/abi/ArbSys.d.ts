...
export interface ArbSysInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getStorageAt", values: [string, BigNumberish]): string;
...
export interface ArbSys extends BaseContract {
    ...
    functions: {
        ...
        getStorageAt(account: string, index: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        mapL1SenderContractAddressToL2Alias(sender: string, dest: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        mapL1SenderContractAddressToL2Alias(sender: string, dest: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getStorageAt(account: string, index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        mapL1SenderContractAddressToL2Alias(sender: string, dest: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
