...
export interface RollupCreatorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setTemplates", values: [string, string, string, string, string]): string;
...
export interface RollupCreator extends BaseContract {
    ...
    functions: {
        ...
        setTemplates(_bridgeCreator: string, _osp: string, _challengeManagerLogic: string, _rollupAdminLogic: string, _rollupUserLogic: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        rollupAdminLogic(overrides?: CallOverrides): Promise<string>;
        rollupUserLogic(overrides?: CallOverrides): Promise<string>;
        setTemplates(_bridgeCreator: string, _osp: string, _challengeManagerLogic: string, _rollupAdminLogic: string, _rollupUserLogic: string, overrides?: CallOverrides): Promise<void>;
        transferOwnership(newOwner: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "OwnershipTransferred(address,address)"(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        "RollupCreated(address,address,address,address,address)"(rollupAddress?: string | null, inboxAddress?: null, adminProxy?: null, sequencerInbox?: null, delayedBridge?: null): RollupCreatedEventFilter;
        RollupCreated(rollupAddress?: string | null, inboxAddress?: null, adminProxy?: null, sequencerInbox?: null, delayedBridge?: null): RollupCreatedEventFilter;
