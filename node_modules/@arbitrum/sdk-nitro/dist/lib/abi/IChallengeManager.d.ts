...
export interface IChallengeManagerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "currentResponderTimeLeft", values: [BigNumberish]): string;
...
export interface IChallengeManager extends BaseContract {
    ...
    functions: {
        ...
        currentResponderTimeLeft(challengeIndex_: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        initialize(resultReceiver_: string, sequencerInbox_: string, delayedBridge_: string, osp_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        currentResponder(challengeIndex: BigNumberish, overrides?: CallOverrides): Promise<string>;
        currentResponderTimeLeft(challengeIndex_: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(resultReceiver_: string, sequencerInbox_: string, delayedBridge_: string, osp_: string, overrides?: CallOverrides): Promise<void>;
        isTimedOut(challengeIndex: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
    ...
    populateTransaction: {
        ...
        currentResponderTimeLeft(challengeIndex_: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(resultReceiver_: string, sequencerInbox_: string, delayedBridge_: string, osp_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
